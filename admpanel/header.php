          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="<?php if(FILE=='donate') echo 'active';?>">
						...
						<li><a href="donate.php" class=""><i class="fa fa-dashboard"></i><span>Donation</span></a></li>               
                  ...
                  <li class="<?php if(FILE=='prize' ) echo 'active';?>">
						...
						<li><a href="prize.php" class=""><i class="fa fa-money"></i> <span>Prizes</span></a></li>
                  ...
                  <li class="<?php if(FILE=='setting' ) echo 'active';?>">
						...
						<li><a href="setting.php" class=""><i class="fa fa-wrench"></i> <span>Settings</span></a></li>
